...
// PlayerDTO p1 = PlayerDTO.builder().id(new UUID(0,
// 0)).name("Santiago").build();
// PlayerDTO p2 = PlayerDTO.builder().id(new UUID(0,
// 0)).name("Nicolas").build();
...
// PlayerDTO p1 = new PlayerDTO(UUID.randomUUID(), "Marcos", new
// TeamDTO("Philadelphia", "", ""));
// PlayerDTO p2 = new PlayerDTO(UUID.randomUUID(), "Mario", new
// TeamDTO("Philadelphia", "", ""));
